  ...
  Widget build(BuildContext context) {
    return Consumer<ProfileProvider>(
      builder: (context, provider, _) {
        ...
        return provider.isChangePassword?ChangePassWidget():Column(
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: SvgPicture.asset(AssetImages.personalInfoIcon),
                          ),
                        ),
                    ...
                    Row(
                      children: [
                        CachedImage(url: provider.user?.image ?? ""),
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.camera_alt_outlined, color: AppColors.grey500),
                                  const SizedBox(width: 12),
                                  TextWidget(
                                    "Change Photo",
                                    textSize: 12,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ButtonWidget(
                            text: "Save Changes",
                            textColor: AppColors.whiteColor,
                            onTap: () => provider.updateInfo(context),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(6.0),
                            child: SvgPicture.asset(AssetImages.settingsIcon),
                          ),
                        ),
                        const SizedBox(width: 12),
                        TextWidget(
